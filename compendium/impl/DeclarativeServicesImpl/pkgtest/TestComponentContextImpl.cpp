...
#include "ServiceComponent/ComponentException.hpp"
...
namespace cppmicroservices {
  namespace scrimpl {
    ...
    TEST_F(ComponentContextImplTest, DISABLED_VerifyLocateServiceWithReferenceScopes)
    {
      ...
      auto VerifyLocateServiceWithScopes = [&](std::string referenceScope,
        ...
        EXPECT_CALL(*mockServiceFactory, GetService(testing::_, testing::_)).WillRepeatedly(testing::Invoke([&](const cppmicroservices::Bundle& bundle,
        ...
        .WillRepeatedly(testing::Invoke([&](const cppmicroservices::Bundle& bundle,
