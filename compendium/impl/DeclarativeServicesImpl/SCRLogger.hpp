...
namespace cppmicroservices {
  namespace scrimpl {
     ...
     * testing purposes.
     */
    class SCRLogger : public cppmicroservices::logservice::LogService,
    ...
    public:
      ...
      std::shared_ptr<TrackedParmType> AddingService(const ServiceReference<cppmicroservices::logservice::LogService>& reference) override;
