...
namespace cppmicroservices {
  namespace scrimpl {
    class MockService : public dummy::Reference1, public dummy::Reference2
    {
    };
    ...
    public:
      ...
      virtual cppmicroservices::InterfaceMapConstPtr GetService(const cppmicroservices::Bundle& bundle,
      ...
      virtual void UngetService(const cppmicroservices::Bundle& bundle,
                                const cppmicroservices::ServiceRegistrationBase& registration,
