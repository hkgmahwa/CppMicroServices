...
#include "ServiceComponent/runtime/dto/ComponentDescriptionDTO.hpp"
#include "ServiceComponent/runtime/dto/ComponentConfigurationDTO.hpp"
#include "ServiceComponent/runtime/dto/ReferenceDTO.hpp"
  ...
  namespace scrimpl {
    ...
    void SCRActivator::CreateExtension(const cppmicroservices::Bundle& bundle)
    {
      ...
      if (!extensionFound)
      {
        ...
        try
        {
          auto const& scrMap = ref_any_cast<util::AnyMap>(headers.at(SERVICE_COMPONENT));
