...
namespace codegen
{
  ...
  {
    CodegenValidManifestState(std::string _manifest, std::vector<std::string> _headers, std::string _referenceOutput)
  ...
  INSTANTIATE_TEST_CASE_P(SuccessModes, ValidCodegenTest,
    testing::Values(
      // valid manifest
  ...
  INSTANTIATE_TEST_CASE_P(FailureModes, InvalidCodegenTest,
    testing::Values(
      CodegenInvalidManifestState(manifest_no_scr,
        "Mandatory name 'scr' missing from the manifest"),
      CodegenInvalidManifestState(manifest_empty_scr,
        "Invalid value for the name 'scr'. Expected non-empty JSON object i.e. collection of name/value pairs"),
      ...
      CodegenInvalidManifestState(manifest_dup_keys,
        "Duplicate key: 'scr'", /*isPartial=*/ true),
      CodegenInvalidManifestState(manifest_illegal_ver,
        "Unsupported manifest file version '0'"),
      CodegenInvalidManifestState(manifest_illegal_ver2,
        "Invalid value for the name 'version'. Expected int"),
      CodegenInvalidManifestState(manifest_illegal_ver3,
        "Invalid value for the name 'version'. Expected int"),
      CodegenInvalidManifestState(manifest_illegal_ver4,
        "Syntax error: value, object or array expected", /*isPartial=*/ true),
      CodegenInvalidManifestState(manifest_missing_ver,
        "Mandatory name 'version' missing from the manifest"),
      CodegenInvalidManifestState(manifest_no_comp,
      ...
      CodegenInvalidManifestState(manifest_empty_impl_class,
        "Invalid value for the name 'implementation-class'. Expected non-empty string"),
      CodegenInvalidManifestState(manifest_no_ref_name,
      ...
      CodegenInvalidManifestState(manifest_dup_ref_interface,
        "Duplicate key: 'interface'", /*isPartial=*/ true),
      CodegenInvalidManifestState(manifest_illegal_service,
        "Invalid value for the name 'service'. Expected non-empty JSON object i.e. collection of name/value pairs"),
      ...
      CodegenInvalidManifestState(manifest_illegal_interfaces,
        "Invalid array value for the name 'interfaces'. Expected non-empty string"),
      ...
      CodegenInvalidManifestState(manifest_illegal_scope,
        "Invalid value 'global' for the name 'scope'. The valid choices are : [singleton, bundle, prototype]"),
