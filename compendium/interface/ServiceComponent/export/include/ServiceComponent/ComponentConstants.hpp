  ...
  namespace service {
    namespace component {
      ...
      namespace ComponentConstants {
         ...
         */
        EXPORT_API extern const std::string SERVICE_COMPONENT;
         ...
         * {@code std::string}.
         */
        EXPORT_API extern const std::string COMPONENT_NAME;
         ...
         */
        EXPORT_API extern const std::string COMPONENT_ID;
         ...
         */
        EXPORT_API extern const std::string REFERENCE_TARGET_SUFFIX;
         ...
         */
        EXPORT_API extern const std::string REFERENCE_SCOPE_PROTOTYPE_REQUIRED;
      }
    }
  }
}
